...
class LandmarkLoss(nn.Module):
    def __init__(self, landmarks_weight={"mouth": 512., "eye": 256., "pupil": 256., "others": 64.}, 
                 rectmask_weight={"leye": 20., "reye": 20., "rectmouth": 40.},
        ...
        self.rectmask_riterion = nn.MSELoss()
    ...
    def forward(self, input, target):
        ...
        return landmarks_loss*4 + rectmask_loss
