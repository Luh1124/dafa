...
if __name__ == "__main__":
    ...
    # parser.add_argument("--test_d", type=str, default='demo/2/d-png/id10468#EICQVj70ePE#00007.txt#000.mp4/00000130.png', help="Driving dir")
    ...
    # 2
    parser.add_argument("--test_d", type=str, default='/data1/datasets/vox1/vox-png/train/id11150#gjFhr6ECQzk#00002.txt#000.mp4/0000100.png', help="Driving dir")
    # 3
    parser.add_argument("--test_s", type=str, default='/data1/datasets/vox1/vox-png/train/id11246#vpUaGfi9KY8#00001.txt#000.mp4/0000204.png', help="Driving dir")
    ...
    # 2
    # parser.add_argument("--test_d", type=str, default='/data1/datasets/vox1/vox-png/train/id10071#A2bWI0qrkd8#00005.txt#000.mp4/0000103.png', help="Driving dir")
    # 3
    # parser.add_argument("--test_s", type=str, default='/data1/datasets/vox1/vox-png/train/id10405#s2qeanh0D7g#00005.txt#000.mp4/0000003.png', help="Driving dir")
